...
from predict_tails import predict_relation_tails, get_preds_df, add_relation_values, predict_relation_tails_rf
...
for n_ests in [10,50,100,200]:
    for max_depth in [3,4,5]:
        for batch_size in [128,256,500,1024]:
